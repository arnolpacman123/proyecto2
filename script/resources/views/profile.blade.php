                                                        ...
                                                        @if(Auth::check())
                                                            ...
                                                            @else
                                                                @if(Auth::User()->isFollowing($user->id))
                                                                    <a class="pjax"
                                                                       href="{{ route('unfollow',$user->id) }}">{{ __('Unfollow') }}</a>
                                                                @else
                                                                    <a class="pjax"
                                                                       href="{{ route('follow',$user->id) }}">{{ __('Follow') }}</a>
                                                                @endif
                                                            @endif
                                                        @else
                                                            <a class="pjax"
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    @if(Auth::check())
                                                        <a href="javascript:void(0)" class="dropdown-item"
                                                           onclick="user_report('{{ $user->slug }}')"><i
                                                                class="far fa-flag"></i> {{ __('Report') }}</a>
                                                    @else
                                                        <a href="{{ route('login') }}" class="pjax dropdown-item"><i
                                                                class="far fa-flag"></i> {{ __('Report') }}</a>
                                                    @endif
                                                </div>
                                            </div>

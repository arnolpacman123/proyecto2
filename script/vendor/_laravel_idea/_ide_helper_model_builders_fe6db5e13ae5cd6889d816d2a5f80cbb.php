<?php //fb692ba1394236422eddb65e503320d9
/** @noinspection all */
...
namespace LaravelIdea\Helper\Illuminate\Notifications {
     ...
     * @method _IH_DatabaseNotification_QB whereParentId($value)
     * @method _IH_DatabaseNotification_QB whereBody($value)
     * @method _IH_DatabaseNotification_QB whereLink($value)
     * @method _IH_DatabaseNotification_QB whereStatus($value)

...
<aside
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0 d-flex text-wrap align-items-center" href=" {{ route('dashboard') }} ">
            ...
            <span class="ms-2 font-weight-bold text-white">Panel de Administración</span>
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            <li class="nav-item mt-3">
                <h6 class="ps-4 ms-2 text-uppercase text-xs text-white font-weight-bolder opacity-8">Administración de Usuario</h6>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ $activePage == 'periodos' ? ' active bg-gradient-primary' : '' }} "
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ $activePage == 'convocatorias' ? ' active bg-gradient-primary' : '' }} "
